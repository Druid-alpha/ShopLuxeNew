...
export default function AdminReviews() {
  ...
  const { data, isLoading, refetch } = useGetAdminReviewsQuery({ page, ...appliedFilters } as any);
                ...
                <div className="flex flex-col md:flex-row gap-6">
                  <div className="md:w-48 space-y-3">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-xs font-black uppercase tracking-tight text-gray-900 truncate max-w-[120px]">
                          {review.user?.name || "Anonymous"}
                        </p>
                        <p className="text-[10px] text-gray-400 font-bold lowercase tracking-tighter">
                          {review.user?.email}
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="pt-2">
                      <span
                        className={`text-[8px] font-black uppercase tracking-widest px-2 py-1 rounded ${
                          review.isVerified ? "bg-green-50 text-green-600" : "bg-gray-50 text-gray-400"
                        }`}
                      >
                    ...
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <div className="flex gap-2">
                        <button
                          ...
                          className={`p-3 rounded-xl transition-all transform group-hover:scale-110 ${
                            review.isFeatured ? "bg-black text-white" : "bg-gray-50 text-gray-400 hover:text-black"
                          }`}
                        >
                          <Home size={16} />
                        </button>
