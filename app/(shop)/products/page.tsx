...
function PageContent() {
  ...
  }, [page, debouncedSearch, category, clothingType, brand, color, minPrice, maxPrice, availability, sortBy, saleOnly, normalizeClothingType, searchParams, pathname, router])
