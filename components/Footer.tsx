      ...
      <div className="max-w-7xl mx-auto px-6 py-20 grid gap-12 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="space-y-6">
          ...
          <ul className="space-y-4 text-xs font-bold uppercase tracking-widest">
            <li><Link className="hover:text-white transition-colors" href="/products">Latest Arrivals</Link></li>
            <li><Link className="hover:text-white transition-colors" href="/products?featured=true">Featured Items</Link></li>
            <li><Link className="hover:text-white transition-colors" href="/wishlist">Your Wishlist</Link></li>
          </ul>
        </div>
        ...
        <div className="space-y-6">
          ...
          <ul className="space-y-4 text-xs font-bold uppercase tracking-widest">
            <li><Link className="hover:text-white transition-colors" href="/profile">Dashboard</Link></li>
            <li><Link className="hover:text-white transition-colors" href="/login">Sign In</Link></li>
            <li><Link className="hover:text-white transition-colors" href="/register">Create Account</Link></li>
          </ul>
        </div>
        ...
        <div className="space-y-6">
          ...
          <ul className="space-y-4 text-xs font-bold uppercase tracking-widest">
            ...
            <li><Link className="hover:text-white transition-colors" href="/terms-of-service">Terms of Service</Link></li>
          </ul>
        </div>
