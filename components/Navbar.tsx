    ...
    <header className="sticky top-0 z-50 bg-white border-b ">
      ...
      <nav className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between gap-4">
        ...
        <div className="hidden md:flex items-center gap-8">
          <Link
            href="/products"
            className={`text-[10px] font-black uppercase tracking-[0.2em] transition-all hover:text-black ${pathname.startsWith('/products') ? 'text-black border-b-2 border-black' : 'text-gray-400'}`}
          >
            Collections
          </Link>
          ...
          <Link href="/cart" className="relative text-gray-400 hover:text-black transition-colors">
          ...
          {/* User menu */}
          {!mounted ? (
            <div className="h-9 w-24" suppressHydrationWarning />
          ) : user ? (
            <DropdownMenu>
          ...
          <div className="flex-1 overflow-y-auto overscroll-contain bg-white">
            ...
            <div className="px-4 space-y-1">
              ...
              <div className="pt-6 space-y-1">
                ...
                <Link href="/wishlist" className="flex items-center justify-between p-4 rounded-2xl hover:bg-gray-50 transition-colors">
                ...
                <Link href="/orders" className="flex items-center justify-between p-4 rounded-2xl hover:bg-gray-50 transition-colors">
                  <div className="flex items-center gap-4">
                    <Package size={20} className="text-slate-900" />
                    <span className="text-sm font-black uppercase tracking-tight">My Orders</span>
                  </div>
                </Link>
                <Link href="/cart" className="flex items-center justify-between p-4 rounded-2xl hover:bg-gray-50 transition-colors">
                  <div className="flex items-center gap-4">
            ...
            {mounted && user ? (
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <Button className="rounded-xl font-black uppercase tracking-widest text-[9px] h-12 shadow-lg shadow-gray-200" asChild onClick={() => setMobileOpen(false)}>
                  <Link href="/register">Join Luxe</Link>
                </Button>
              </div>
            )}
          </div>
